...
[DroneKit](http://dronekit.io)을 이용해서 UAV용 app을 만들 수 있습니다. 이 app은 UAV의 Companion Computer에서 실행되며 계산이 많고 빠르게 데이터 전송(e.g. computer vision)이 필요한 타스크를 실행해서 자동비행 기능을 향상시킵니다.

DroneKit과 PX4는 현재 완전히 호환되도록 개발 중입니다. DroneKit-python 2.2.0에서 미션 처리와 비행체 모니터링에 대해서 기본으로 지원하고 있다.

## DroneKit을 PX4와 셋업하기

현재 master에서 DroneKit-python 설치를 시작해 봅시다.
